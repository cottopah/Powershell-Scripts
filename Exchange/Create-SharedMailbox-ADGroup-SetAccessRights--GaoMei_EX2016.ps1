...
###
$CompanyBrand = "GaoMei"
$CompanyBrandCountry = "GM"
$CompanyCountryCode = "CN"
$CompanyName = "GaoMei"
$CompanyOffice = "Hefei"
$ADUserUPNSuffix = "gaomei.cn"
$ADUserOU = "OU=GaoMei,OU=GaoMei,OU=Resource Mailboxes,OU=Mail Contacts and Resource Mailboxes,DC=tennant,DC=tco,DC=corp"
$SharedMBXEmailDomain = "gaomei.cn"
$ADGroupOU = "OU=Security,OU=GaoMei,OU=GaoMei,OU=User Account Groups,OU=Account Groups,DC=tennant,DC=tco,DC=corp"
