...
###
$CompanyBrand = "IPC"
$CompanyBrandCountry = "SP"
$CompanyCountryCode = "ES"
$CompanyName = "IPCleaning"
$CompanyOffice = "Barcelona"
$ADUserUPNSuffix = "ipcleaning.net"
$ADUserOU = "OU=IPCleaning,OU=IPC,OU=Resource Mailboxes,OU=Mail Contacts and Resource Mailboxes,DC=tennant,DC=tco,DC=corp"
$SharedMBXEmailDomain = "ipcleaning.net"
$ADGroupOU = "OU=Security,OU=IPCleaning,OU=IPC,OU=User Account Groups,OU=Account Groups,DC=tennant,DC=tco,DC=corp"
