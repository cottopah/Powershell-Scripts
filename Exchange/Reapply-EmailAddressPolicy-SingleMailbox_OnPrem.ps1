...
Get-Mailbox -Identity $UserID | Select Name,@{N='UserID';E={$_.SamAccountName}},@{N='EmailAddress';E={$_.PrimarySmtpAddress}} | FL
...
Set-Mailbox -Identity $UserID -EmailAddressPolicyEnabled $false
...
Set-Mailbox -Identity $UserID -EmailAddressPolicyEnabled $true
